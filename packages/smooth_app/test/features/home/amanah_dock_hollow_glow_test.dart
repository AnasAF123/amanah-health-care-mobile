...
void main() {
  ...
  group('Amanah Dock Hollow Glow Painter Tests', () {
    test(
      'AmanahDockHollowGlowPainter repaints on dragProgress and isLongPressing changes',
      () {
        const AmanahDockHollowGlowPainter painterIdle =
            AmanahDockHollowGlowPainter(
              dragProgress: 0.0,
              isLongPressing: false,
              isActivating: false,
            );

        const AmanahDockHollowGlowPainter painterDragging =
            AmanahDockHollowGlowPainter(
              dragProgress: 0.6,
              isLongPressing: false,
              isActivating: false,
        ...
        const AmanahDockHollowGlowPainter painterLongPress =
            AmanahDockHollowGlowPainter(
              dragProgress: 0.0,
              isLongPressing: true,
              isActivating: false,
    ...
    test(
      'AmanahDockHollowGlowPainter paints all 6 layers without exceptions',
      () {
        ...
        // Paint idle state
        const AmanahDockHollowGlowPainter idlePainter =
            AmanahDockHollowGlowPainter(
              dragProgress: 0.0,
              isLongPressing: false,
              isActivating: false,
        ...
        const AmanahDockHollowGlowPainter dragPainter =
            AmanahDockHollowGlowPainter(
              dragProgress: 0.75,
              isLongPressing: false,
              isActivating: false,
        ...
        const AmanahDockHollowGlowPainter longPressPainter =
            AmanahDockHollowGlowPainter(
              dragProgress: 0.0,
              isLongPressing: true,
              isActivating: false,
