...
void main() {
  ...
  group('Amanah Account Tab Screen Tests', () {
    ...
    testWidgets(
      ...
      expect(
        find.text('✓ Terverifikasi Manajemen RS Amanah Sehat'),
        findsOneWidget,
      );
    ...
    testWidgets('Tapping Bantuan teknisi IT navigates to IT support and flows',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.75;
      addTearDown(() => tester.view.reset());
      ...
      // Open FAQ Detail
      await tester.tap(find.text('Kamera scanner presensi tidak merespons atau blank hitam'));
      await tester.pumpAndSettle();
