...
void main() {
  ...
  group('Amanah Notification Tab Screen Tests', () {
    testWidgets('Renders header, filter chips, and 6 initial notification items',
    ...
    testWidgets('Tapping notification opens detail modal and marks it as read',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.75;
      addTearDown(() => tester.view.reset());
    ...
    testWidgets('Options menu: Bersihkan Terbaca removes read notifications and shows empty state',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.75;
      addTearDown(() => tester.view.reset());
