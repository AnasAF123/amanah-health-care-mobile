...
void main() {
  ...
  group('Amanah Presence History Screen Tests', () {
    ...
    testWidgets('Tapping info icon opens Keterangan Timeline Presensi drawer',
      ...
      expect(find.text('Tutup Informasi'), findsOneWidget);
    });

    testWidgets('Tapping Lihat Alasan on cuti record opens Leave Reason drawer',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.75;
      addTearDown(() => tester.view.reset());
    ...
    testWidgets('Tapping filter button opens Filter drawer and applying filter updates list',
        (WidgetTester tester) async {
      tester.view.physicalSize = const Size(1080, 2400);
      tester.view.devicePixelRatio = 2.75;
      addTearDown(() => tester.view.reset());
